...
export default function ServiciosPage() {
  return (
    <main>
      ...
      {/* Services */}
      <section className="bg-[#0F2234] pb-32">
            ...
            {servicios.map((s, i) => {
              ...
              return (
                <FadeIn key={s.title} delay={i * 0.08}>
                  <div className="group grid lg:grid-cols-[80px_1fr_auto] gap-6 lg:gap-12 py-14 border-b border-white/[0.06] hover:border-[#C7AB65]/15 transition-colors duration-400">
                    {/* Number + icon */}
                    <div className="flex lg:flex-col items-center lg:items-start gap-4 lg:gap-4">
                      ...
                      <div className="w-10 h-10 border border-white/[0.07] group-hover:border-[#C7AB65]/25 flex items-center justify-center transition-colors duration-400">
                        <Icon
                          size={17}
