...
export default function ContactForm() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <h3 className="text-xl font-normal text-[#0F2234] mb-3">Mensaje enviado</h3>
        <p className="text-[#334155] font-normal max-w-sm leading-relaxed">
  ...
  const inputClass =
    "w-full bg-transparent border border-white/[0.1] px-4 py-3.5 text-sm text-[#0F2234] placeholder:text-[#334155] focus:outline-none focus:border-[#C7AB65]/50 transition-colors duration-300 font-normal";
    ...
    <div className="space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div className="relative">
          ...
          >
            <option value="" className="bg-white text-[#334155]">
              Tipo de proyecto
            </option>
            {tiposProyecto.map((t) => (
