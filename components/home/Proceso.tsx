      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-[2.75rem] font-light text-white tracking-tight leading-tight">
            ...
            <span className="text-[#C5A55A] italic">planificación y control.</span>
          </h2>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-6 relative">
          ...
          <div className="hidden lg:block absolute top-[22px] left-[10%] right-[10%] h-px bg-gradient-to-r from-transparent via-[#C5A55A]/20 to-transparent pointer-events-none" />
          ...
          {steps.map((step, i) => (
            ...
            >
              {/* Step marker */}
              <div className="relative z-10 w-11 h-11 border border-[#C5A55A]/25 group-hover:border-[#C5A55A]/60 bg-[#080808] flex items-center justify-center mb-6 transition-colors duration-400">
                <span className="text-[11px] font-medium text-[#C5A55A]/60 group-hover:text-[#C5A55A] tracking-wider transition-colors duration-400">
                  {step.number}
                </span>
              </div>
